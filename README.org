...
** ~make restart_all~ and ~make restart (ui|lang|rest)~
This command will restart either all services or the specific service by completely cleaning the docker images cache and reloading the new configuration for the given service.
